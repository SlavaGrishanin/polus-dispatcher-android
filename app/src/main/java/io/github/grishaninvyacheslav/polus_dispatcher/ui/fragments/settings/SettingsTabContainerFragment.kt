...
class SettingsTabContainerFragment : BaseTabContainerFragment<FragmentTabContainerBinding>(
    ...
    companion object {
        ...
        fun newInstance(containerTag: TabTag) =
            SettingsTabContainerFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (childFragmentManager.findFragmentById(R.id.ftc_container) == null) {
            cicerone.router.replaceScreen(screens.settings(containerTag))
        }
    }
