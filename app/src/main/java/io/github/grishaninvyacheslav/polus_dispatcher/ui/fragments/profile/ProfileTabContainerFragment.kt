...
class ProfileTabContainerFragment : BaseTabContainerFragment<FragmentTabContainerBinding>(
    ...
    companion object {
        ...
        fun newInstance(containerTag: TabTag) =
            ProfileTabContainerFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (childFragmentManager.findFragmentById(R.id.ftc_container) == null) {
            cicerone.router.replaceScreen(screens.profile(containerTag))
        }
    }
